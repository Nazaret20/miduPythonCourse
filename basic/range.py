...
for cinco in range(0, 51, 5): print(cinco)
...
for inverso in range(10, 0, -1): print(inverso)
...
num_multiplicar = int(input("Introduce un número: "))
result = 0

for number in range(1, 11):
    result = num_multiplicar * number
    print(f"{num_multiplicar} x {number} = {result}")
